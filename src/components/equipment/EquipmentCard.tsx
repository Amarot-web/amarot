...
import { Equipment } from '@/app/(public)/alquiler/data/equipment';
  ...
  return (
    <div className="group bg-white rounded-xl border border-gray-100 overflow-hidden hover:shadow-lg hover:border-gray-200 transition-all duration-300">
      ...
      <div className="relative aspect-square bg-gray-50 p-4 overflow-hidden">
        <img
          src={equipment.image}
          alt={`HILTI ${equipment.model} - Alquiler en Perú`}
      ...
      <div className="p-4">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold py-2.5 px-4 rounded-lg transition-colors text-sm"
        >
