    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-blue-50 rounded-lg p-3">
          ...
          <p className="text-lg font-bold text-blue-900">
            {formatCurrency(totals.itemsTotal, currency)}
          </p>
        </div>
        ...
        <div className="bg-purple-50 rounded-lg p-3">
          <p className="text-xs text-purple-600">Materiales + Equipos</p>
          <p className="text-lg font-bold text-purple-900">
            {formatCurrency(totals.materialsTotal + totals.equipmentTotal, currency)}
          </p>
        </div>
      </div>
      ...
      <div className="bg-[#1E3A8A]/5 border border-[#1E3A8A]/20 rounded-lg p-4">
        <div className="flex items-center justify-between mb-2">
          <label className="font-semibold text-gray-900">Margen de Ganancia</label>
          <span className="text-2xl font-bold text-[#1E3A8A]">{marginPercentage}%</span>
        </div>
        <input
          type="range"
          min="30"
      ...
      <div className="bg-white border-2 border-[#1E3A8A] rounded-lg p-4 space-y-3">
        <div className="flex justify-between text-gray-600">
          ...
          <span>{formatCurrency(totals.costTotal, currency)}</span>
        </div>
        <div className="flex justify-between text-gray-600">
          <span>Margen ({marginPercentage}%):</span>
          <span className="text-green-600">+{formatCurrency(totals.marginAmount, currency)}</span>
        </div>
        ...
        <div className="flex justify-between text-xl font-bold border-t-2 border-[#1E3A8A] pt-3">
          <span>TOTAL:</span>
