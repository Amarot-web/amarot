...
export default function QuotationActions({ quotationId, status }: QuotationActionsProps) {
  ...
  return (
    <>
      <div className="flex items-center justify-end gap-1">
        ...
        {isDraft && (
          <Link
            href={`/cotizador/${quotationId}/editar`}
        ...
        {/* PDF */}
        <Link
          href={`/cotizador/${quotationId}/pdf`}
          className="p-2 text-gray-500 hover:text-[#DC2626] hover:bg-red-50 rounded-lg transition-colors"
          title="Ver PDF"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 13h6m-6 4h6m-3-8V4" />
          </svg>
        </Link>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-xl shadow-xl p-6 mx-4" style={{ width: '400px', maxWidth: 'calc(100vw - 2rem)' }}>
            ...
            <p className="text-gray-600 mb-6 text-sm text-center" style={{ wordWrap: 'break-word', whiteSpace: 'normal' }}>
              ¿Estás seguro de que deseas eliminar esta cotización? Se eliminarán todos los items y costos asociados.
            </p>
