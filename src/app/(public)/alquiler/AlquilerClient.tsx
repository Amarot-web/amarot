...
import type { WhatsAppLinks } from '@/lib/contact/whatsapp';
...
export default function AlquilerClient({ wa }: { wa: WhatsAppLinks }) {
          ...
          <AnimatedSection animation="fade-up">
            <div className="text-center lg:text-left lg:max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <a
                  href={`${wa.waLink}?text=Hola,%20me%20interesa%20alquilar%20equipos%20HILTI`}
                  target="_blank"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection animation="fade-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href={`${wa.waLink}?text=Hola,%20necesito%20cotizar%20el%20alquiler%20de%20equipos%20HILTI`}
                target="_blank"
                rel="noopener noreferrer"
