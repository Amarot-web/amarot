...
export const services: ServiceData[] = [
  {
    ...
    metaTitle: 'Perforaciones Diamantinas en Lima, Perú | AMAROT',
  ...
  },
  {
    ...
    metaTitle: 'Sellos Cortafuego en Lima, Perú | AMAROT',
    metaDescription: 'Aplicación profesional de sellos cortafuego en Lima: juntas, ductos y penetraciones. Químicos HILTI certificados. 20+ años de experiencia.',
